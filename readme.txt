...
Friendly integration of Google Map intance in your blogs. Allow display multiples on your pages. Insert posts/pages on maps using a custon field. 

== Description ==

This plugin allows you to include instances of Google Map in your blogs using the  shortcode  API. You can insert the maps everywhere: in your theme files, posts and pages.  The use of a custom field allows you to insert  posts on your maps as points.
